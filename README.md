...
- 🔷 **Eshuzo** — *Interactive Agency Landing Page*
  ...
  - **Highlights**: Scroll-Driven Reveals, Parallax Depth Effects, Spring Physics.

- 📊 **GitHub Profile Analyzer** — *Full Stack Analytics Web App*
  - **Tech Stack**: React + Vite, Express, MySQL, Tailwind CSS, Recharts.
  - **Highlights**: Direct connection to GitHub Public API with caching & algorithm ratings.

---

<div align="center">
  <sub>Designed with ❤️ by <b>Kushal Banerjee</b></sub>
</div>
